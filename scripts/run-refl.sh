...
test_path=`realpath /home/dj/mtp/stava/tests/test12/`
...
# $java_vm -Xmx1g -classpath $soot_path:${stava_path}/src main.Main $java_install_path false $test_path Main $output_path
$java_vm -Xmx1g -classpath $soot_path:${stava_path}/src main.Main $java_install_path true $test_path Refl $output_path
